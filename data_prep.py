...
train_listfile = pd.read_csv('data-full/decompensation/train/listfile.csv')
test_listfile = pd.read_csv('data-full/decompensation/test/listfile.csv')
...
# val_listfile.to_csv('data/val_listfile.csv', index=False)
...
# # train_listfile_new.to_csv('data/decompensation/train/listfile.csv', index=False)
# test_listfile.to_csv('data/test_listfile.csv', index=False)
